...
import game.battlesystem.databaseImpls.AbilityManager;
import game.battlesystem.databaseImpls.Effects;
import game.battlesystem.databaseImpls.Effects.Name;
import game.battlesystem.databaseImpls.Elements;
...
public class Entity implements Comparable<Entity>
{
    ...
    public EntityInfoItem toEII(){
      try{
        return new EntityInfoItem(name,speed,getAbNames(),getEffectsNames(),getStartingShieldNames(),maxHealth,shieldHealth);
      }catch(Exception e){
    ...
    private ArrayList<Effects.Name> getEffectsNames() throws Exception{
    ...
    private ArrayList<Shields.Name> getStartingShieldNames() throws Exception{
