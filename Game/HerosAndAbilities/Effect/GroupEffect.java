...
public class GroupEffect extends Effect {
  ...
  public GroupEffect(String name, String desc, Element element, Effect...effects){
    super(0, EffectList.EffectType.GROUP, 0, true, name, desc, element);
    listOfEffects = new ArrayList<>();
    groupDuration = 0;
    for (int i = 0; i < effects.length; i++){
      Effect e = effects[i].copyEffect();
      listOfEffects.add(i, effects[i].copyEffect());
  ...
  private GroupEffect(String name, String desc, Element element, ArrayList<Effect> effects){
    super(0, EffectList.EffectType.GROUP, 0, false, name, desc, element);
    listOfEffects = new ArrayList<>();
    groupDuration = 0;
  ...
  @Override 
  public void applyEffect(EffectList.EffectType type, Superhero target){
    for (int i = listOfEffects.size() - 1; i >= 0; i--){
      Effect e = listOfEffects.get(i);
  ...
  public Effect copyEffect(){
    return new GroupEffect(getName(), getDesc(), getElement(), listOfEffects);
  }
